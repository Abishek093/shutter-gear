...
const loadReport = async (req, res) => {
    try {
        ...
        if (reportOrder === "Daily") {
            ...
            const startOfYear = new Date(today.getFullYear(), 0, 1); // Fix: Define startOfYear
        ...
        // Calculate total revenue, total sales, and total products sold based on filtered orders
